(() => {
    ...
    const IC = {
        ...
        pause:    `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" fill="currentColor"><rect x="5.5" y="3.5" width="4.5" height="17" rx="2"/><rect x="14" y="3.5" width="4.5" height="17" rx="2"/></svg>`,
        skipBack: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none"><path d="M12.5 4.5V2L8 5.5l4.5 3.5V6.5a6 6 0 1 1-6 6H5a7.5 7.5 0 1 0 7.5-8Z" fill="currentColor"/><text x="12.5" y="15.5" text-anchor="middle" font-family="Inter, system-ui, -apple-system, sans-serif" font-size="6.5" font-weight="700" fill="currentColor">10</text></svg>`,
        skipFwd:  `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none"><path d="M11.5 4.5V2l4.5 3.5-4.5 3.5V6.5a6 6 0 1 0 6 6H19a7.5 7.5 0 1 1-7.5-8Z" fill="currentColor"/><text x="11.5" y="15.5" text-anchor="middle" font-family="Inter, system-ui, -apple-system, sans-serif" font-size="6.5" font-weight="700" fill="currentColor">10</text></svg>`,
        pip:      `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="18" rx="3"/><rect x="11" y="10" width="10" height="8" rx="2" fill="currentColor" stroke="none"/></svg>`,
        fullscreen:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 9V5.5A1.5 1.5 0 0 1 5.5 4H9"/><path d="M15 4h3.5A1.5 1.5 0 0 1 20 5.5V9"/><path d="M20 15v3.5a1.5 1.5 0 0 1-1.5 1.5H15"/><path d="M9 20H5.5A1.5 1.5 0 0 1 4 18.5V15"/></svg>`,
        rotate:   `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12a8 8 0 0 1 14.3-4.9" stroke="currentColor"/><path d="M20 4v4h-4" stroke="currentColor"/><path d="M20 12a8 8 0 0 1-14.3 4.9" stroke="currentColor"/><path d="M4 20v-4h4" stroke="currentColor"/></svg>`,
